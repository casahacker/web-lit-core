...
#### Descrição
Nessa discussão/atividade off-line, os participantes consideram a pesquisa na web e porque ela é tão importante e tão desafiadora. Eles aprendem sobre programas de _software_ chamados “rastreadores web” e “mecanismos de pesquisa” que ajudam a encontrar e fornecer resultados de pesquisa entre bilhões e bilhões de recursos da web. Os participantes também recebem uma introdução aos algoritmos e praticam a escrita e a revisão de algoritmos.
